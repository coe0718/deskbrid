...
| [Backend Parity Pass](BACKEND_PARITY.md) | Matrix-backed compositor audit plus X11/COSMIC shared Linux domain implementations and explicit unsupported capability reporting | `src/backend/`, `src/daemon/capabilities/`, `docs/BACKEND_PARITY.md` |
